<?php
namespace ItBlaster\FixturesBundle\Command;

use ItBlaster\FixturesBundle\DataFixtures\Loader\YamlDataLoader;
...
class FixturesLoadCommand extends AbstractCommand
{
    ...
    {
        $this
            ->setName('it-blaster:fixtures:load')
            ->setDescription('Загрузка fixtures из yml,xml файлов')
            ...
            ->setHelp(<<<EOT
The <info>it-blaster:fixtures:load</info> loads <info>XML</info>, <info>SQL</info> and/or <info>YAML</info> fixtures.

  <info>php app/console it-blaster:fixtures:load</info>
